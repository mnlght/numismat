...
<html class="no-js" lang="">
    <head>
        ...
        <title>Поиск <?php echo $search;?> | Нумизматика</title>
	            ...
	            <div class="row">
					<div class="col-md-12">
						<ul class="page-menu">
							...
							<li class="active"><a href="main.php">Поиск по названию</a></li>
						</ul>
					</div>
				</div>
				<div class="row">
								...
								<div class="col-xs-12">
									...
									<div class="product-menu">
										<div class="product-title">
											<h3 class="title-group-3 gfont-1">Все монеты по поиску '<?=$search?>'</h3>
										</div>
									</div>
										...
										<div class="tab-content">
												...
												<div class="row">
													<div class="listview">
														...
														error_reporting( E_ERROR );
															...
															$count = mysql_query("SELECT COUNT(*) FROM table_products WHERE title LIKE '%$search%' ORDER BY products_id DESC",$link);
														...
														<?php
																				...
																				$result = mysql_query("SELECT * FROM table_products WHERE title LIKE '%$search%' ORDER BY products_id DESC $qury_start_num ",$link);
																				...
																				if (mysql_num_rows($result) > 0)
																					...
																					}else{echo '<p>Ничего не найдено</p>';}}}else{echo '<p>Задан пустой поисковый запрос</p>';}
																			?>
																														...
																														<div class="row">
																															<div class="col-xs-5">
																																<div class="pagination">
																																	<ul>
																																	';
																																	echo $pstr_prev.$page5left.$page4left.$page3left.$page2left.$page1left."<li class='active'><a  href='search.php?q='.$search.'&page=".$page."'>".$page."</a></li>".$page1right.$page2right.$page3right.$page4right.$page5right.$strtotal.$pstr_next;
																																	echo'
																																	</ul>
																																</div>
											...
											<div role="tabpanel" class="tab-pane fade " id="display-1-2">
												...
												<?php
													...
													<?php
																				$query = mysql_query("SET NAMES utf8");
																				$result = mysql_query("SELECT * FROM table_products WHERE title LIKE '%$search%' ORDER BY products_id DESC ",$link);
																				if (mysql_num_rows($result) > 0)
																					{
																						$row = mysql_fetch_array($result);
					...
					$(function() {
					  $( "#slider-range" ).slider({
					   ...
					   slide: function( event, ui ) {
						$( "#start_price" ).val(ui.values[ 0 ] + " -  " + ui.values[ 1 ]  );
					   }
					  });
					  $( "#start_price" ).val($( "#slider-range" ).slider( "values", 1 )   +
