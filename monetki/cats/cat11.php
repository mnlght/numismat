...
<html class="no-js" lang="">
    <head>
        ...
        <title>Северная Америка | Нумизматика</title>
								...
								<div class="col-xs-12">
									...
									<div class="product-menu">
										<div class="product-title">
											<h3 class="title-group-3 gfont-1">Все монеты в категории Северная Америка:</h3>
										</div>
									</div>
									<div class="product-filter">
										...
										<div class="sort">
											...
											<option value="cat11.php"><?php echo $sort_name; ?></option>
											<option value="cat11.php?sort=name" >Название</option>
											<option value="cat11.php?sort=price-asc">Цена по возрастанию</option>
											<option value="cat11.php?sort=price-desc">Цена по убыванию</option>
											<option value="cat11.php?sort=data">Дата создания</option>
											<option value="cat11.php?sort=nominal">Номинал</option>
											</select>	
										</div>
										<div class="limit">
											<label>Вид:</label>
									...
									<div class="product">
										<div class="tab-content">
											...
											<div role="tabpanel" class="tab-pane fade in active" id="display-1-1">
												<div class="row">
													<div class="listview">
														...
														error_reporting( E_ERROR );
															...
															$count = mysql_query("SELECT COUNT(*) FROM table_products WHERE type='Северная Америка'",$link);
														...
														<?php
																				...
																				$result = mysql_query("SELECT * FROM table_products WHERE type='Северная Америка' ORDER BY $sorting $qury_start_num",$link);
												...
												<?php
																  error_reporting( E_ERROR );
																	if ($page != 1) { $pstr_prev = '<li><a class="pstr-prev" href="cat11.php?page='.($page - 1).'">&lt;</a></li>';}
																	if ($page != $total) $pstr_next = '<li><a class="pstr_next" href="cat11.php?page='.($page + 1).'">&gt;</a></li>';

																	//Формируем ссылки со страницами
																	if($page - 5 > 0) $page5left = '<li><a href="cat11.php?page='.($page - 5).'">'.($page - 5).'</a></li>';
																	if($page - 4 > 0) $page4left = '<li><a href="cat11.php?page='.($page - 4).'">'.($page - 4).'</a></li>';
																	if($page - 3 > 0) $page3left = '<li><a href="cat11.php?page='.($page - 3).'">'.($page - 3).'</a></li>';
																	if($page - 2 > 0) $page2left = '<li><a href="cat11.php?page='.($page - 2).'">'.($page - 2).'</a></li>';
																	if($page - 1 > 0) $page1left = '<li><a href="cat11.php?page='.($page - 1).'">'.($page - 1).'</a></li>';

																	if($page + 5 <= $total) $page5right = '<li><a href="cat11.php?page='.($page + 5).'">'.($page + 5).'</a></li>';
																	if($page + 4 <= $total) $page4right = '<li><a href="cat11.php?page='.($page + 4).'">'.($page + 4).'</a></li>';
																	if($page + 3 <= $total) $page3right = '<li><a href="cat11.php?page='.($page + 3).'">'.($page + 3).'</a></li>';
																	if($page + 2 <= $total) $page2right = '<li><a href="cat11.php?page='.($page + 2).'">'.($page + 2).'</a></li>';
																	if($page + 1 <= $total) $page1right = '<li><a href="cat11.php?page='.($page + 1).'">'.($page + 1).'</a></li>';


																	if ($page+5 < $total)
																	{
																		$strtotal = '<li><p class="nav-point">...</p></li><li><a href="cat11.php?page='.$total.'">'.$total.'</a></li>';
																														...
																														<div class="row">
																															<div class="col-xs-5">
																																<div class="pagination">
																																	<ul>
																																	';
																																	echo $pstr_prev.$page5left.$page4left.$page3left.$page2left.$page1left."<li class='active'><a  href='cat11.php?page=".$page."'>".$page."</a></li>".$page1right.$page2right.$page3right.$page4right.$page5right.$strtotal.$pstr_next;
																																	echo'
																																	</ul>
																																</div>
											...
											<div role="tabpanel" class="tab-pane fade " id="display-1-2">
												<div class="row">
													...
													<?php
																				$query = mysql_query("SET NAMES utf8");
																				$result = mysql_query("SELECT * FROM table_products WHERE type='Северная Америка' ORDER BY $sorting ",$link);
