...
$myrow = mysql_fetch_array($result);
	...
	<h3>Извините, введённый вами логин или пароль неверный." . "<a href='login.php'> <b>Назад</b> </a></h3></div></body>");
    }
    else {
   ...
   header("Location:main.php"); 
     ...
     {exit ('<body><div align="center"><br/><br/><br/><p style="font-size:20px; font-weight: 900; color:#26acca;"> Извините, введённый вами login или пароль неверный.
        <p><button value="Вернуться"><a style="text-transform: uppercase; text-decoration: none;" href="login.php">Вернуться</a></button></div></div></body>');}
    }
////////
