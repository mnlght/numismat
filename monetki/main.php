    ...
    <body>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="top-menu">
								...
								<p class="welcome-msg">Добро пожаловать, <?=$_SESSION['login']?>! </p>
								<!-- End Currency -->
							</div>
								...
								<div class="col-xs-12">
									...
									<div class="product-menu">
										<div class="product-title">
											<h3 class="title-group-3 gfont-1"><p style="font-size:2em; font-weight: 900; color:#26acca; padding:3.5em;"> Выберите категорию из доступных</h3>
										</div>
									</div>
							</div>
							';
												...
												<div class="row">
													<div class="listview">
														...
														<?php
																				...
																				$user_id = $_SESSION['id'];
																				$user_result = mysql_query("SELECT price FROM users WHERE id=$user_id");
		...
		<!-- FOOTER-AREA END -->	
				<script>
					...
					alert(a);
					if (a!=1) {$(".fa-trash-o").addClass("display-none")}*/
				</script>
				<!-- jquery
		============================================ -->		
